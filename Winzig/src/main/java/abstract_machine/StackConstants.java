...
public class StackConstants {
    ...
    public static class DataMemoryNodeNames {
        ...
        public static final String EXPNode = "**";
        ...
        public static final String ForUpNode = "upfor";
        public static final String ForDownNode = "downfor";
        ...
        public static final String RangeNode = "range";
        ...
        public static final String CharTNode = "char";
        public static final String FunctionNode = "fnc";
        public static final String ProcedureNode = "proc";
